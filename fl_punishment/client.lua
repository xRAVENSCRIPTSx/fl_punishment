...
CreateThread(function()
	...
	TriggerEvent("chat:addSuggestion", Config.PanelCommand, Locales.hu.panel_suggestion)

	TriggerEvent("chat:addSuggestion", Config.ComservCommand, Locales.hu.comserv_suggestion, {
    { name = "id", help = "Target Player ID" },
    { name = "count", help = "Tasks Count" },
    { name = "reason", help = "Reason" },
	})
	TriggerEvent("chat:addSuggestion", Config.EndComservCommand, Locales.hu.endcomserv_suggestion, {
    { name = "id", help = "Target Player ID" },
	})

	TriggerEvent("chat:addSuggestion", Config.BanCommand, Locales.hu.ban_suggestion, {
    { name = "id", help = "Target Player ID" },
    { name = "days", help = "Days (0 - Infinity)" },
    { name = "reason", help = "Reason" },
	})
	TriggerEvent("chat:addSuggestion", Config.UnbanCommand, Locales.hu.remban_suggestion, {
    { name = "name", help = "Identifier / Character Name" },
	})

	TriggerEvent("chat:addSuggestion", Config.JailCommand, Locales.hu.jail_suggestion, {
    { name = "id", help = "Target Player ID" },
    { name = "minutes", help = "Minutes" },
    { name = "reason", help = "Reason" },
	})
	TriggerEvent("chat:addSuggestion", Config.EndJailCommand, Locales.hu.endjail_suggestion, {
    { name = "id", help = "Target Player ID" },
	})
end)
