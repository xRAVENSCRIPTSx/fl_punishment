...
RegisterCommand(Config.PanelCommand, function(player)
...
RegisterCommand(Config.ComservCommand, function(player, args)
	local xPlayer = ESX.GetPlayerFromId(player)
...
RegisterCommand(Config.EndComservCommand, function(player, args)
	if not isAdmin(player) then
		return
	end
...
RegisterCommand(Config.BanCommand, function(player, args)
	local xPlayer = ESX.GetPlayerFromId(player)
...
RegisterCommand(Config.UnbanCommand, function(player, args)
	local xPlayer = ESX.GetPlayerFromId(player)
	if not xPlayer or not isAdmin(xPlayer) then
		return
	end
...
RegisterCommand(Config.JailCommand, function(player, args)
	local xPlayer = ESX.GetPlayerFromId(player)
	if not xPlayer or not isAdmin(xPlayer) then
		return
	end
...
RegisterCommand(Config.EndJailCommand, function(player, args)
	local xPlayer = ESX.GetPlayerFromId(player)
	if not xPlayer or not isAdmin(xPlayer) then
		return
	end
